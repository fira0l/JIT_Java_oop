...
class EmployeeManagement {
    ...
    // A method to calculate the total salary of all employees
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                if(line.contains("Salary :")){
                    String salary = line.substring(line.lastIndexOf(":") + 1);
    ...
    void displayEmployeeDataBySalary() {
        ...
        while (flag) {
            ...
            switch (choose) {
                ...
                case 6:
                    ...
                    employees.calculateTotalSalary();
                    break;
                case 7:
                    employees.displayEmployeeDataBySalary();
                    break;
                case 8:
                    flag = false;
                    break;
